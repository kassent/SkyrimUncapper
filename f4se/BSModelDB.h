...
public:
	...
	public:
		...
		DEFINE_MEMBER_FN(dtor, void, 0x01C65310);
		DEFINE_MEMBER_FN(Impl_Process, void, 0x001367D0, ModelData * modelData, const char * modelName, NiAVObject ** root, UInt32 * typeOut);
	};
};
