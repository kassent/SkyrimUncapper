...
RelocPtr <BSRenderer*> g_renderer(0x0679FD78);

// 6BF9214E9DC5338FC817F85B0716990E5CA7C862+31
RelocPtr <BSRenderManager> g_renderManager(0x06161880);
...
RelocPtr <ID3D11DeviceContext*>		g_D3D11DeviceContext(0x0615EBE0);
