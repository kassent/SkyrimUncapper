...
public:
	...
	DEFINE_MEMBER_FN(Construct, BSResourceNiBinaryStream *, 0x01B6AE60, const char * filePath, UInt8 unk1, UInt64 unk2, SInt8 unk3);	// unk1 = 0, unk2 = 0, unk3 = 0
	DEFINE_MEMBER_FN(ReadLine, UInt32, 0x01B6B360, char * dst, UInt32 dstLen, UInt32 terminator);
	DEFINE_MEMBER_FN(Destroy, void, 0x01B6B120);	// ??_7BSResourceNiBinaryStream@@6B@ first entry
	DEFINE_MEMBER_FN(IsValid, bool, 0x01B6B240, void);
	DEFINE_MEMBER_FN(Seek, void, 0x01B6B250, SInt64);
	DEFINE_MEMBER_FN(Unk_04, SInt64, 0x01B6B2C0, void * unk1);
	DEFINE_MEMBER_FN(Read, UInt32, 0x01B6B420, void * buf, UInt64 length);
	DEFINE_MEMBER_FN(Write, UInt32, 0x01B6B4B0, void * buf, UInt64 length);
