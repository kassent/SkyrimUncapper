...
public:
	...
	DEFINE_MEMBER_FN(LockTextureType, void, 0x01D0A6B0, UInt32 type);
	// 043E0332BAAAC13F99024C3C6EF85D0377BBAA12+14D
	DEFINE_MEMBER_FN(ReleaseTextureType, void, 0x01D0A740, UInt32 type);
	DEFINE_MEMBER_FN(GetRenderData, BSRenderData *, 0x01D0A610, UInt32 type, UInt64 unk1, UInt64 unk2, UInt32 unk3); // type, 0, 1, 0
	// 264CB6DCC7DACA88AC30E4EC83671FAAFBA2E490+1FD
	DEFINE_MEMBER_FN(Unk_01, void, 0x01D0A660, UInt32 type, BSRenderData *, UInt8 unk3); // type, rendererData, 1
};
